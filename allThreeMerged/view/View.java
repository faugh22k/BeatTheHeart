...
public class View implements MouseListener{
	...
	public void init(GameContainer gc) throws SlickException {
		...
		club=new ClubSprite();
		club.init();
		container.getInput().addMouseListener(club);
	}
	
	public BeatTheHeartSprite addBalloonSprite(Balloon b) throws SlickException{
		...
		balloon.init();
		sprites.add(balloon);
		container.getInput().addMouseListener(balloon);
		return balloon;
	}
	
	public BeatTheHeartSprite addGoodieSprite(Goodie g) throws SlickException{
		...
		goodie.init();
		sprites.add(goodie);
		container.getInput().addMouseListener(goodie);
		return goodie;
	}
